...
class BottomCurvedNavBarExSecond extends StatefulWidget {
  const BottomCurvedNavBarExSecond({Key? key}) : super(key: key);

  @override
  _BottomCurvedNavBarExSecondState createState() =>
      _BottomCurvedNavBarExSecondState();
}

class _BottomCurvedNavBarExSecondState
    extends State<BottomCurvedNavBarExSecond> {
  int _page = 0;
